...
def computeK(horizon, elem_area, nbr_lst, mw, bulk, mu, elem_cent):
...
nbr_lst, _, _, _, _ = peridym_get_neighbor_data(m, horizon)
...
print("composition of stiffness matrix completed\n")
